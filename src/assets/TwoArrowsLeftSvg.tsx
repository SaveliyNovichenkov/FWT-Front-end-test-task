...
interface TwoArrowsLeftSvgProps extends DetailedHTMLProps<HTMLAttributes<SVGSVGElement>, SVGSVGElement> {}

const TwoArrowsLeftSvg = ({ className, ...props }: TwoArrowsLeftSvgProps) => {
  return (
    <svg
...
export default TwoArrowsLeftSvg
