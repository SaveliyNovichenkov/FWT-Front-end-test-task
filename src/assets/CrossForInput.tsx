...
interface CrossForInputProps extends DetailedHTMLProps<HTMLAttributes<SVGSVGElement>, SVGSVGElement> {}

const CrossForInput = ({ className, ...props }: CrossForInputProps) => {
  return (
    <svg
